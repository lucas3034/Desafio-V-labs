...
import { Card, Button, Grid, Flex, LoadingSpinner, Badge } from '../styles/GlobalStyles';
...
const Dashboard = () => {
  ...
  const getUserRole = (course) => {
    ...
    if (course.instructors.map(String).includes(String(user.id))) return 'Instrutor';
    return null;
  };
  ...
  return (
    <div>
      <WelcomeSection>
        ...
        <WelcomeSubtitle>
          Bem-vindo de volta ao CourseSphere
        </WelcomeSubtitle>
        ...
        <>
          ...
          <Grid>
            {courses.map(course => {
              ...
              return (
                <CourseCard key={course.id} as={Link} to={`/courses/${course.id}`}>
                  <CourseHeader>
                    <Flex justify="space-between" align="flex-start">
                      <CourseTitle>{course.name}</CourseTitle>
                      {userRole && (
                        <Badge variant={userRole === 'Criador' ? 'primary' : 'success'}>
                          {userRole}
                        </Badge>
                      )}
                    </Flex>
                ...
                <CourseMeta>
                  ...
                  <MetaItem>
                    <MetaIcon>👥</MetaIcon>
                    <strong>Instrutores:</strong> {course.instructors.length}
                  </MetaItem>
                </CourseMeta>
